...
function collison(enemy) {
    if (inEnemy(player.x, player.y, enemy)) 
        return true;
    else if (inEnemy(player.x + player.size, player.y, enemy)) 
        return true;
    else if (inEnemy(player.x, player.y + player.size, enemy)) 
        return true;
